/**
 * Cron semanal: sync completo de miembros + posts desde Circle
 * Ejecutado por Vercel Cron: 0 4 * * 1 (lunes 4:00 AM UTC)
...
export async function GET(req: NextRequest) {
  ...
  console.log(`[cron] circle-sync: ${memberRecords.length} members, ${postRecords.length} posts`);
